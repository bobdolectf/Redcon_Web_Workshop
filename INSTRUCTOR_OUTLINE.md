...
[Basic Request Smuggling] <https://portswigger.net/web-security/request-smuggling/lab-basic-cl-te>

//walkthrough
navigate to main page and open http history
swap method from GET to POST and throw it into repeater
notice the response and play around with it
try modifying the Transfer-Encoding to chunked as below:

you need to send it twice thu repeater
```
POST / HTTP/1.1

Host: 0a2400690476e4b8c0569d5600b90077.web-security-academy.net
...
//Make sure the students understand Burp repeater options and to turn off the auto-content length updater

[TE Header] <https://portswigger.net/web-security/request-smuggling/lab-obfuscating-te-header>
...
//Walkthrough
Make sure you have the auto content length off and keep the null space at the bottom

```
POST / HTTP/1.1
Host: 0a86002104fe7723c04684e700c700e0.web-security-academy.net
